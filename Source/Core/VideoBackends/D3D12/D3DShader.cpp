...
bool CompileShader(const std::string& code, D3DBlob** blob, const D3D_SHADER_MACRO* defines, const char* shader_version_string)
{
...
#endif
	HRESULT hr = d3d_compile(code.c_str(), code.length(), nullptr, defines, nullptr, "main", shader_version_string,
